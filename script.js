...
function  updateTotals() {
  try {
    ...
    for(let item = 0 ; item < items.length; item++) {
      ...
      if (isNaN(value)) {
        return alert("Não foi possível calcular o total. O valor não parece" +
          " ser um número.")
      }
...
// Limpa os inputs do formulário e coloca o foco no input expense.
function formClear() {
  // Limpa os inputs.
  expense.value = ""
  category.value = ""
  ...
  // Coloca o foco no input expense.
  expense.focus()
}
